...
/*!**************************************************!*\
  !*** ./resources/js/utilities/classicService.js ***!
  \**************************************************/
/*! exports provided: equation, timer, gameTimer, sorted */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var equation = {
  ...
  generateDOM: function generateDOM() {
    ...
    equations.forEach(function (equation) {
      ...
      if (countOfData == 2) {
        htmlDOM += "<div class=\"row-".concat(countOfData, "-").concat(countOfData + 1, "\">");
      }

      htmlDOM += "<div class=\"row\" id=\"row-".concat(countOfData, "\"><span class=\"data\" id=\"data-").concat(countOfData, "\" data-answer=").concat(equation.answer, " >").concat(equation.a).concat(operation).concat(equation.b, "=?</span></div>");
    ...
    this.answers = [];
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('div.game-grid').html(htmlDOM);
    this.level++;
    htmlDOMLvl = 'Level: ' + this.level;
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('div.level span#level').html(htmlDOMLvl);
  }
};
var timer = {
  minutes: 0,
  ...
  playagain: function playagain() {
    ...
    gameTimer.minutes = 0;
    gameTimer.seconds = 0;
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('div#main-default-summary').removeClass("fadein-animation");
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('div#main-default-summary').hide();
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.eq-content-area').show();
    this["continue"]();
  },
  loading: function loading() {
    if (jquery__WEBPACK_IMPORTED_MODULE_0___default()("#content-section").hasClass("start")) {
      setTimeout(function () {
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('#main-default-loading').hide();
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('body#main-default').removeClass('flex-jc-c-imp');
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('div#main-default-summary').hide();
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('.eq-content-area').show();
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('#content-section').removeClass('start');
        timer["continue"]();
      }, 3000);
    }
  },
  ...
  createDisplay: function createDisplay() {
    ...
    if (!jquery__WEBPACK_IMPORTED_MODULE_0___default()('body#main-default').hasClass('flex-jc-c-imp')) {
      setTimeout(function () {
        _this.loading();
      }, 3000);
    }
    ...
    if (this.seconds < 10) {
      if (this.seconds == 0 && this.minutes > 0) {
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('div .timer-container input#timer').val("".concat(this.minutes, ": 0").concat(this.seconds));
        setTimeout(function () {
          jquery__WEBPACK_IMPORTED_MODULE_0___default()('div .timer-container input#timer').val("".concat(_this.minutes, ": ").concat(_this.seconds));
        }, 1000);
        return;
      }
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('div .timer-container input#timer').val("".concat(this.minutes, ": ").concat(this.seconds));
  },
  ...
  setGameOver: function setGameOver() {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('div#main-default-summary').show();
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('body#main-default').addClass("flex-jc-c-imp"); // setTimeout(() => { 
    //  }, 3000)

    gameTimer.trophyCount();
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('span#summary-trophy').text("Trophy: " + gameTimer.trophy);
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('span#summary-level').text("Level: " + equation.level);
    clearInterval(this.timerLoop);
    clearInterval(gameTimer.timerLoop);
  },
...
var gameTimer = {
  ...
  timerLoop: null,
  init: function init() {
    var countUpTimer = this.countUpTimer.bind(this);
  ...
  countUpTimer: function countUpTimer() {
    ...
    this.minutes = Math.floor(newSeconds / 60);
    this.createDisplay();
    console.log("CountUpTimer | minute: ".concat(this.minutes, " | seconds: ").concat(this.seconds));
  },
  trophyCount: function trophyCount() {
    var numberofSeconds = this.minutes * 60 + this.seconds;
    this.trophy = Math.floor(numberofSeconds / 30);

    if (this.addtrophycounter == this.trophy) {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('span#add-trophy').addClass("add-trophy-absolute move-up-animation");
      setTimeout(function () {
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('span#add-trophy').removeClass("add-trophy-absolute move-up-animation");
      }, 1500);
  ...
  createDisplay: function createDisplay() {
    this.trophyCount();
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('div .timer-container input#trophy').val("".concat(this.trophy));
    return;
  }
};
function sorted(arr) {
  ...
  for (var first_index = 0; first_index < arr.length; first_index++) {
    second_index = first_index + 1;
...
/***/ 3:
/*!********************************************************!*\
  !*** multi ./resources/js/utilities/classicService.js ***!
  \********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
