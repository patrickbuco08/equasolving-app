  ...
  return _regeneratorRuntime().wrap(function _callee8$(_context8) {
    while (1) {
      switch (_context8.prev = _context8.next) {
        case 0:
          console.log('init navigator'); //validation sa pag input ng nickname
                ...
                while (1) {
                  switch (_context.prev = _context.next) {
                    case 0:
                      e.preventDefault();
                      _context.next = 3;
                      return createUserUsingNickName();
          ...
          jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on('click', '#menu-btn-1', /*#__PURE__*/function () {
