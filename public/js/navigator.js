...
/* harmony import */ var _utilities_modalService__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./utilities/modalService */ "./resources/js/utilities/modalService.js");
    ...
    while (1) {
      switch (_context13.prev = _context13.next) {
        case 0:
          ...
          BgMusicSwitch = function BgMusicSwitch() {
          ...
          jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on('click', '#SFXOnOff', function (e) {
            if (window.location.pathname != "/") return;
            var equasolve_sfx = null; //if naka on

            if (isSfxOn()) {
              //then, off
              equasolve_sfx = "false";
              jquery__WEBPACK_IMPORTED_MODULE_0___default()("#sfxImg").attr('src', "/images/music-off.png");
              _sfx__WEBPACK_IMPORTED_MODULE_1__["default"].tap.volume(0);
            } else {
              //on the sfx
              equasolve_sfx = "true";
              jquery__WEBPACK_IMPORTED_MODULE_0___default()("#sfxImg").attr('src', "/images/music-on.png");
          ...
          jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on("click", '#settings', function (e) {
            ...
            modalContent.html(_utilities_modalService__WEBPACK_IMPORTED_MODULE_3__["modalSettings"]);
          ...
          jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on("click", "button#classic-tutorial", function (e) {
            ...
            _sfx__WEBPACK_IMPORTED_MODULE_1__["default"].tap.play();
            var modalContent = jquery__WEBPACK_IMPORTED_MODULE_0___default()('section#overlay div.modal-content');
            modalContent.html(_utilities_modalService__WEBPACK_IMPORTED_MODULE_3__["modalClassicTutorial"]);
          }); // read pvp tutorial
          ...
          jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on("click", "button#pvp-tutorial", function (e) {
            ...
            _sfx__WEBPACK_IMPORTED_MODULE_1__["default"].tap.play();
            var modalContent = jquery__WEBPACK_IMPORTED_MODULE_0___default()('section#overlay div.modal-content');
            modalContent.html(_utilities_modalService__WEBPACK_IMPORTED_MODULE_3__["modalPvpTutorial"]);
          ...
          jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on('keyup', 'input[name="set-nickname"]', function (e) {
            e.preventDefault();
            var nickname = jquery__WEBPACK_IMPORTED_MODULE_0___default()('input[name="set-nickname"]').val();
            var disabledButton = nickname ? true : false;
            console.log(disabledButton);
            _sfx__WEBPACK_IMPORTED_MODULE_1__["default"].tap.play();
            jquery__WEBPACK_IMPORTED_MODULE_0___default()('button[name="add-nickname"]').attr('disabled', !disabledButton);
            jquery__WEBPACK_IMPORTED_MODULE_0___default()('button[name="update-nickname"]').attr('disabled', !disabledButton);
          }); //submit nickname

          jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on('click', 'button[name="add-nickname"]', /*#__PURE__*/function () {
                ...
                while (1) {
                  switch (_context.prev = _context.next) {
                    case 0:
                      ...
                      _sfx__WEBPACK_IMPORTED_MODULE_1__["default"].tap.play();
                      _context.next = 5;
                      return Object(_utilities_request__WEBPACK_IMPORTED_MODULE_2__["createUserUsingNickname"])();
          ...
          jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on('click', 'button[name="update-nickname"]', /*#__PURE__*/function () {
                ...
                while (1) {
                  switch (_context2.prev = _context2.next) {
                    case 0:
                      ...
                      _sfx__WEBPACK_IMPORTED_MODULE_1__["default"].tap.play();
                      _context2.next = 4;
                      return Object(_utilities_request__WEBPACK_IMPORTED_MODULE_2__["updateNickName"])();
          ...
          jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on('click', '#menu-btn-1', function (e) {
            e.preventDefault();
            _sfx__WEBPACK_IMPORTED_MODULE_1__["default"].tap.play();
              ...
              return _regeneratorRuntime().wrap(function _callee3$(_context3) {
                while (1) {
                  switch (_context3.prev = _context3.next) {
                    case 0:
                      _sfx__WEBPACK_IMPORTED_MODULE_1__["default"].menu.fade(1, 0, 1000, menuBgMusic);
                      _context3.next = 3;
                      return Object(_utilities_request__WEBPACK_IMPORTED_MODULE_2__["renderClassic"])();

                    case 3:
                      classic = _context3.sent;
                      jquery__WEBPACK_IMPORTED_MODULE_0___default()('div#root').html(classic);
              ...
              return _regeneratorRuntime().wrap(function _callee5$(_context5) {
                while (1) {
                  switch (_context5.prev = _context5.next) {
                    ...
                    case 7:
                      _sfx__WEBPACK_IMPORTED_MODULE_1__["default"].tap.on("end", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4() {
                        var findMatch;
                        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
                          while (1) {
                            switch (_context4.prev = _context4.next) {
                              ...
                              case 2:
                                findMatch = _context4.sent;
                                jquery__WEBPACK_IMPORTED_MODULE_0___default()('div#root').html(findMatch);
          ...
          jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on('click', '#menu-btn-3', /*#__PURE__*/function () {
          ...
          jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on('click', '#profile', /*#__PURE__*/function () {
              ...
              return _regeneratorRuntime().wrap(function _callee7$(_context7) {
                while (1) {
                  switch (_context7.prev = _context7.next) {
                    case 0:
                      e.preventDefault();
                      _sfx__WEBPACK_IMPORTED_MODULE_1__["default"].tap.volume(localStorage.getItem("equasolve_sfx") === "true" ? 1 : 0);
                      _sfx__WEBPACK_IMPORTED_MODULE_1__["default"].tap.play();
                      _context7.next = 5;
                      return Object(_utilities_request__WEBPACK_IMPORTED_MODULE_2__["renderMatchHistory"])();

                    case 5:
                      matchHistory = _context7.sent;
                      jquery__WEBPACK_IMPORTED_MODULE_0___default()('div#root').html(matchHistory);
          ...
          jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on('click', '#render-home', /*#__PURE__*/function () {
                ...
                while (1) {
                  switch (_context9.prev = _context9.next) {
                    case 0:
                      e.preventDefault();
                      _sfx__WEBPACK_IMPORTED_MODULE_1__["default"].tap.play();
                      _sfx__WEBPACK_IMPORTED_MODULE_1__["default"].tap.on("end", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee8() {
                        var home;
                        return _regeneratorRuntime().wrap(function _callee8$(_context8) {
                          while (1) {
                            switch (_context8.prev = _context8.next) {
                              case 0:
                                _context8.next = 2;
                                return Object(_utilities_request__WEBPACK_IMPORTED_MODULE_2__["renderHome"])();

                              case 2:
                                home = _context8.sent;
                                jquery__WEBPACK_IMPORTED_MODULE_0___default()('div#root').html(home);
          ...
          jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on('click', '#render-home-skeleton', /*#__PURE__*/function () {
                ...
                while (1) {
                  switch (_context10.prev = _context10.next) {
                    case 0:
                      ...
                      _sfx__WEBPACK_IMPORTED_MODULE_1__["default"].tap.play();
                      _context10.next = 4;
                      return Object(_utilities_request__WEBPACK_IMPORTED_MODULE_2__["renderHomeSkeleton"])();

                    case 4:
                      home = _context10.sent;
                      jquery__WEBPACK_IMPORTED_MODULE_0___default()('div#root').html(home);
          ...
          jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on("click", "h1#set-nickname", function (e) {
            e.preventDefault();
            _sfx__WEBPACK_IMPORTED_MODULE_1__["default"].tap.play();
            var modalContent = jquery__WEBPACK_IMPORTED_MODULE_0___default()('section#overlay div.modal-content');
            var renderSetNickname = Object(_utilities_modalService__WEBPACK_IMPORTED_MODULE_3__["setNickName"])(jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).text());
            modalContent.html(renderSetNickname);
            jquery__WEBPACK_IMPORTED_MODULE_0___default()('section#overlay').show();
          }); //logout confirmation

          jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on("click", "div#logout-confirmation", function (e) {
            e.preventDefault();
            _sfx__WEBPACK_IMPORTED_MODULE_1__["default"].tap.play();
            var modalContent = jquery__WEBPACK_IMPORTED_MODULE_0___default()('section#overlay div.modal-content');
            modalContent.html(_utilities_modalService__WEBPACK_IMPORTED_MODULE_3__["logOutConfirmation"]);
            jquery__WEBPACK_IMPORTED_MODULE_0___default()('section#overlay').show();
          }); //logout

          jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on('click', 'button#logout', /*#__PURE__*/function () {
                ...
                while (1) {
                  switch (_context12.prev = _context12.next) {
                    case 0:
                      e.preventDefault();
                      _sfx__WEBPACK_IMPORTED_MODULE_1__["default"].tap.play();
                      _sfx__WEBPACK_IMPORTED_MODULE_1__["default"].tap.on("end", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee11() {
