...
/* harmony import */ var _sfx__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./sfx */ "./resources/js/sfx.js");
/* harmony import */ var _utilities_request__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./utilities/request */ "./resources/js/utilities/request.js");
...
_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
  var classicUI, BgMusicSwitch, sfxSwitch, animation, classPatern, onAnswerEquationAnimation;
  return _regeneratorRuntime().wrap(function _callee$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          onAnswerEquationAnimation = function _onAnswerEquationAnim() {
            var status = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : false;
            var logoAnimationClass = "text-danger ".concat(animation.failed, " red"),
                timerAnimationClass = "text-danger red"; //if status is true, triggered correct answer animation

            if (status) {
              logoAnimationClass = "text-success ".concat(animation.success, " green");
              timerAnimationClass = "text-success green";
            } // reset the equation UI


            jquery__WEBPACK_IMPORTED_MODULE_1___default()('div.equation').removeClass('active');
            jquery__WEBPACK_IMPORTED_MODULE_1___default()('div.equation span.circle').removeClass(classPatern); // add answer animation in logo

            jquery__WEBPACK_IMPORTED_MODULE_1___default()('div#classic-logo').addClass(logoAnimationClass).one(animation.ends, function () {
              jquery__WEBPACK_IMPORTED_MODULE_1___default()('div#classic-logo').removeClass(logoAnimationClass);
            }); // add answer animation in countdown

            jquery__WEBPACK_IMPORTED_MODULE_1___default()('div#countdown-timer-container').addClass(timerAnimationClass);
            setTimeout(function () {
              jquery__WEBPACK_IMPORTED_MODULE_1___default()('div#countdown-timer-container').removeClass(timerAnimationClass);
            }, 1000); //not working
          ...
          _context.next = 3;
          return Object(_utilities_request__WEBPACK_IMPORTED_MODULE_3__["sleep"])(1000);

        case 3:
          _context.next = 5;
          return Object(_utilities_request__WEBPACK_IMPORTED_MODULE_3__["renderClassicSkeleton"])();

        case 5:
          classicUI = _context.sent;
          //get the classic UI
          jquery__WEBPACK_IMPORTED_MODULE_1___default()('div#root').html(classicUI); //render classic UI
          ...
          if (BgMusicSwitch) {
            _sfx__WEBPACK_IMPORTED_MODULE_2__["default"].classic.play();
          }
          ...
          jquery__WEBPACK_IMPORTED_MODULE_1___default()(document).on('click', 'div.equation', function (e) {
            e.preventDefault();
            var answer = jquery__WEBPACK_IMPORTED_MODULE_1___default()(this).data('answer'),
                lastAnswer = _utilities_classicService__WEBPACK_IMPORTED_MODULE_0__["equation"].answers.slice(-1)[0] ? _utilities_classicService__WEBPACK_IMPORTED_MODULE_0__["equation"].answers.slice(-1)[0] : null,
                patternUI = jquery__WEBPACK_IMPORTED_MODULE_1___default()(this).children('span.circle');
            console.log(answer);
            _sfx__WEBPACK_IMPORTED_MODULE_2__["default"].tap.play(); //check if the equation you tap is already selected
            ...
            if (jquery__WEBPACK_IMPORTED_MODULE_1___default()(this).hasClass('active')) {
              ...
              if (answer == lastAnswer) {
                _utilities_classicService__WEBPACK_IMPORTED_MODULE_0__["equation"].answers.pop();
                jquery__WEBPACK_IMPORTED_MODULE_1___default()(this).removeClass('active');
                patternUI.removeClass(classPatern);
              }
            } else {
              //push your answer
              _utilities_classicService__WEBPACK_IMPORTED_MODULE_0__["equation"].setAnswer(answer);
              patternUI.addClass("selected-".concat(_utilities_classicService__WEBPACK_IMPORTED_MODULE_0__["equation"].answers.length));
            ...
            if (_utilities_classicService__WEBPACK_IMPORTED_MODULE_0__["equation"].answers.length == 4) {
              console.log('your answers', _utilities_classicService__WEBPACK_IMPORTED_MODULE_0__["equation"].answers); //correct answer

              if (_utilities_classicService__WEBPACK_IMPORTED_MODULE_0__["equation"].isAnswerSorted()) {
                _sfx__WEBPACK_IMPORTED_MODULE_2__["default"].correct.play();
                ...
                // incorrect
                _sfx__WEBPACK_IMPORTED_MODULE_2__["default"].incorrect.play();
                ...
                jquery__WEBPACK_IMPORTED_MODULE_1___default()('div.equation').removeClass('active');
                jquery__WEBPACK_IMPORTED_MODULE_1___default()('div.equation span.circle').removeClass(classPatern);
                onAnswerEquationAnimation();
              }
            }
          }); //show settings

          jquery__WEBPACK_IMPORTED_MODULE_1___default()('#settings').on("click", function (e) {
            e.preventDefault();
            _utilities_classicService__WEBPACK_IMPORTED_MODULE_0__["timer"].pause();
          }); // hide settings

          jquery__WEBPACK_IMPORTED_MODULE_1___default()('#close').on("click", function (e) {
            e.preventDefault();
            jquery__WEBPACK_IMPORTED_MODULE_1___default()("#settings-modal").hide();
            _utilities_classicService__WEBPACK_IMPORTED_MODULE_0__["timer"]["continue"]();
          }); //show exit confirmation modal

          jquery__WEBPACK_IMPORTED_MODULE_1___default()('#exit-game').on("click", function (e) {
            e.preventDefault();
            _sfx__WEBPACK_IMPORTED_MODULE_2__["default"].tap.play();
            var modalContent = jquery__WEBPACK_IMPORTED_MODULE_1___default()('section#overlay div.modal-content');
            modalContent.html(_utilities_modalService__WEBPACK_IMPORTED_MODULE_4__["modalExitGame"]);
            jquery__WEBPACK_IMPORTED_MODULE_1___default()('section#overlay').show();
            _utilities_classicService__WEBPACK_IMPORTED_MODULE_0__["timer"].pause();
          }); //cancel exit modal

          jquery__WEBPACK_IMPORTED_MODULE_1___default()(document).on("click", "button#modal-cancel", function (e) {
            e.preventDefault();
            if (window.location.pathname != "/classic") return;
            _utilities_classicService__WEBPACK_IMPORTED_MODULE_0__["timer"]["continue"]();
          }); // exit the game

          jquery__WEBPACK_IMPORTED_MODULE_1___default()(document).on("click", "button#exit", function (e) {
            e.preventDefault();
            jquery__WEBPACK_IMPORTED_MODULE_1___default()('section#overlay').hide();
            _utilities_classicService__WEBPACK_IMPORTED_MODULE_0__["timer"].quit();
          }); // toggle background music

          jquery__WEBPACK_IMPORTED_MODULE_1___default()(document).on('click', '#musicOnOff', function () {
            if (window.location.pathname != "/classic") return;
            ...
            jquery__WEBPACK_IMPORTED_MODULE_1___default()("#musicImg").attr('src', "/images/music-".concat(!musicFXisOn ? 'on' : 'off', ".png"));
          ...
          jquery__WEBPACK_IMPORTED_MODULE_1___default()(document).on('click', '#SFXOnOff', function (e) {
            if (window.location.pathname != "/classic") return;
            console.log('trigger settings on classic');
            ...
            jquery__WEBPACK_IMPORTED_MODULE_1___default()("#sfxImg").attr('src', "/images/music-".concat(isSfxOn() ? 'on' : 'off', ".png"));
          }); //reset selected equation

          jquery__WEBPACK_IMPORTED_MODULE_1___default()('div.button-reset').on("click", function (e) {
            e.preventDefault(); // reset the equation UI
...
var sfx = {
  menu: new howler__WEBPACK_IMPORTED_MODULE_0__["Howl"]({
    src: ['/sfx/menu.mp3'],
    loop: true
  }),
  ...
  pvp: new howler__WEBPACK_IMPORTED_MODULE_0__["Howl"]({
    src: ['/sfx/pvp.mp3'],
    loop: true
  }),
  tick: new howler__WEBPACK_IMPORTED_MODULE_0__["Howl"]({
    src: ['/sfx/clock.mp3'],
    loop: false
  }),
  incorrect: new howler__WEBPACK_IMPORTED_MODULE_0__["Howl"]({
  ...
  lose: new howler__WEBPACK_IMPORTED_MODULE_0__["Howl"]({
    src: ['/sfx/lose.mp3'],
    loop: false
  }),
  win: new howler__WEBPACK_IMPORTED_MODULE_0__["Howl"]({
    src: ['/sfx/win.mp3'],
    loop: false
  })
};
/* harmony default export */ __webpack_exports__["default"] = (sfx);
...
/*!************************************************!*\
  !*** ./resources/js/utilities/modalService.js ***!
  \************************************************/
/*! exports provided: modalPurchaseTheme, modalEquipConfirmation, modalInsufficientTheme, modalSettings, modalThemeEquiped, modalThemePurchased, modalClassicTutorial, modalPvpTutorial, modalExitGame, logOutConfirmation, setNickName */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var modalSettings = function modalSettings() {
  var BgMusicSwitch = function BgMusicSwitch() {
...
var logOutConfirmation = function logOutConfirmation() {
...
/*!*******************************************!*\
  !*** ./resources/js/utilities/request.js ***!
  \*******************************************/
/*! exports provided: createUserUsingNickname, getAuthenticatedUser, logoutUser, renderClassic, renderClassicSkeleton, renderClassicSummary, renderFindMatch, renderHome, renderHomeSkeleton, renderLoader, renderMatchHistory, renderShop, equipTheme, purchaseTheme, updateNickName, sleep */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var origin = window.location.origin,
    token = jquery__WEBPACK_IMPORTED_MODULE_0___default()('meta[name="csrf_token"]').attr('content');

var createUserUsingNickname = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return axios({
              method: 'POST',
              url: "".concat(origin, "/user/create-using-nickname"),
              data: {
                nickname: nickname,
                _token: token
              }
          ...
          case 14:
            _context.prev = 14;
            jquery__WEBPACK_IMPORTED_MODULE_0___default()('button[name="add-nickname"]').text('Submit');
  ...
  return function createUserUsingNickname() {
    return _ref.apply(this, arguments);
  };
}();

var updateNickName = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            nickname = jquery__WEBPACK_IMPORTED_MODULE_0___default()('input[name="set-nickname"]').val();
            _context2.prev = 1;
            jquery__WEBPACK_IMPORTED_MODULE_0___default()('button[name="update-nickname"]').text('Saving....').attr('disabled', true);
            console.log('Please Wait...');
            _context2.next = 6;
            return axios({
              method: 'POST',
              url: "".concat(origin, "/user/update-nickname"),
              data: {
                nickname: nickname,
                _token: token
              }
          ...
          case 6:
            ...
            console.log(response.data);
            jquery__WEBPACK_IMPORTED_MODULE_0___default()('h1#set-nickname').text(nickname);
          ...
          case 15:
            _context2.prev = 15;
            jquery__WEBPACK_IMPORTED_MODULE_0___default()('button[name="update-nickname"]').text('Submit');
  ...
  return function updateNickName() {
...
var getAuthenticatedUser = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
    var response, renderedSetNickname;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _context3.prev = 0;
            _context3.next = 3;
            return axios.get("".concat(origin, "/user/check-auth"));
          ...
          case 8:
            ...
            _context3.next = 14;
            return renderSetNickname();

          case 14:
            renderedSetNickname = _context3.sent;
            jquery__WEBPACK_IMPORTED_MODULE_0___default()('div#root').html(renderedSetNickname);
  ...
  return function getAuthenticatedUser() {
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          ...
          case 9:
            ...
            return _context6.abrupt("return", "Sorry, something went wrong...");
...
var renderLoader = /*#__PURE__*/function () {
  var _ref7 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7(text) {
    var response;
      ...
      while (1) {
        switch (_context8.prev = _context8.next) {
          ...
          case 7:
            ...
            return _context8.abrupt("return", "Sorry, something went wrong...");
      ...
      while (1) {
        switch (_context9.prev = _context9.next) {
          ...
          case 7:
            ...
            return _context9.abrupt("return", "Sorry, something went wrong...");
    ...
    return _regeneratorRuntime().wrap(function _callee12$(_context12) {
      while (1) {
        switch (_context12.prev = _context12.next) {
          case 0:
            level = _args12.length > 0 && _args12[0] !== undefined ? _args12[0] : 0;
            trophies = _args12.length > 1 && _args12[1] !== undefined ? _args12[1] : 0;
            _context12.prev = 2;
            _context12.next = 5;
      ...
      while (1) {
        switch (_context13.prev = _context13.next) {
          ...
          case 7:
            ...
            return _context13.abrupt("return", "Sorry, something went wrong...");
    ...
    return _regeneratorRuntime().wrap(function _callee14$(_context14) {
      while (1) {
        switch (_context14.prev = _context14.next) {
          case 0:
            _context14.prev = 0;
            jquery__WEBPACK_IMPORTED_MODULE_0___default()('button#logout').text('Logging out...');
            _context14.next = 4;
            return axios({
              method: 'POST',
      ...
      while (1) {
        switch (_context15.prev = _context15.next) {
          ...
          case 7:
            ...
            return _context15.abrupt("return", "Sorry, something went wrong...");
