...
/* harmony import */ var _utilities_request__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./utilities/request */ "./resources/js/utilities/request.js");
      ...
      switch (_context.prev = _context.next) {
        case 0:
          onAnswerEquationAnimation = function _onAnswerEquationAnim() {
            ...
            jquery__WEBPACK_IMPORTED_MODULE_2___default()('div.equation').removeClass('active');
            jquery__WEBPACK_IMPORTED_MODULE_2___default()('div.equation span.circle').removeClass(classPatern); // add answer animation in logo

            jquery__WEBPACK_IMPORTED_MODULE_2___default()('div#classic-logo').addClass(logoAnimationClass).one(animation.ends, function () {
              jquery__WEBPACK_IMPORTED_MODULE_2___default()('div#classic-logo').removeClass(logoAnimationClass);
            }); // add answer animation in countdown

            jquery__WEBPACK_IMPORTED_MODULE_2___default()('div#countdown-timer-container').addClass(timerAnimationClass);
            setTimeout(function () {
              jquery__WEBPACK_IMPORTED_MODULE_2___default()('div#countdown-timer-container').removeClass(timerAnimationClass);
            }, 1000); //not working
          ...
          _context.next = 3;
          return Object(_utilities_request__WEBPACK_IMPORTED_MODULE_4__["sleep"])(1000);

        case 3:
          _context.next = 5;
          return Object(_utilities_request__WEBPACK_IMPORTED_MODULE_4__["renderClassicSkeleton"])();

        case 5:
          classicUI = _context.sent;
          //get the classic UI
          jquery__WEBPACK_IMPORTED_MODULE_2___default()('div#root').html(classicUI); //render classic UI
          ...
          jquery__WEBPACK_IMPORTED_MODULE_2___default()(document).on('click', 'div.equation', function (e) {
            e.preventDefault();
            var answer = jquery__WEBPACK_IMPORTED_MODULE_2___default()(this).data('answer'),
                lastAnswer = _utilities_classicService__WEBPACK_IMPORTED_MODULE_0__["equation"].answers.at(-1),
                patternUI = jquery__WEBPACK_IMPORTED_MODULE_2___default()(this).children('span.circle');
            console.log(answer);
            _sfx__WEBPACK_IMPORTED_MODULE_3__["default"].tap.play(); //check if the equation you tap is already selected

            if (jquery__WEBPACK_IMPORTED_MODULE_2___default()(this).hasClass('active')) {
            ...
            if (_utilities_classicService__WEBPACK_IMPORTED_MODULE_0__["equation"].answers.length == 4) {
              ...
              if (_utilities_classicService__WEBPACK_IMPORTED_MODULE_0__["equation"].isAnswerSorted()) {
                ...
                jquery__WEBPACK_IMPORTED_MODULE_2___default()('div.equation').removeClass('active');
                jquery__WEBPACK_IMPORTED_MODULE_2___default()('div.equation span.circle').removeClass(classPatern);
                onAnswerEquationAnimation();
              }
            }
          }); //show settings

          jquery__WEBPACK_IMPORTED_MODULE_2___default()('#settings').on("click", function (e) {
            e.preventDefault();
            _utilities_classicService__WEBPACK_IMPORTED_MODULE_0__["timer"].pause();
          }); // hide settings

          jquery__WEBPACK_IMPORTED_MODULE_2___default()('#close').on("click", function (e) {
            e.preventDefault();
          ...
          jquery__WEBPACK_IMPORTED_MODULE_2___default()('#exit-game').on("click", function (e) {
            e.preventDefault();
            jquery__WEBPACK_IMPORTED_MODULE_2___default()("#exit-modal").show();
            _utilities_classicService__WEBPACK_IMPORTED_MODULE_0__["timer"].pause();
          }); //cancel exit modal

          jquery__WEBPACK_IMPORTED_MODULE_2___default()('#cancel').on("click", function (e) {
            e.preventDefault();
            jquery__WEBPACK_IMPORTED_MODULE_2___default()("#exit-modal").hide();
            _utilities_classicService__WEBPACK_IMPORTED_MODULE_0__["timer"]["continue"]();
          }); // exit the game

          jquery__WEBPACK_IMPORTED_MODULE_2___default()('#exit').on("click", function (e) {
            e.preventDefault();
            jquery__WEBPACK_IMPORTED_MODULE_2___default()("#exit-modal").hide();
          ...
          jquery__WEBPACK_IMPORTED_MODULE_2___default()("#SFXOnOff").on('click', function (e) {
            ...
            jquery__WEBPACK_IMPORTED_MODULE_2___default()("#sfxImg").attr('src', "/images/music-".concat(isSfxOn() ? 'on' : 'off', ".png"));
          }); //reset selected equation

          jquery__WEBPACK_IMPORTED_MODULE_2___default()('div.button-reset').on("click", function (e) {
